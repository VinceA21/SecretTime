...
// Array ( [email] => rajamanjeet91@gmail.com [username] => assistant [password] => 12345 [location] => Indiaa [age] => 45 [bodytype] => 2 [ethnicity] => 1 )
		...
		<div class="container">
			<div class="col-md-5 d-block m-auto">
				<div class="FormBox">
					...
					<form id="signupFemale" method="POST" >
						<div class="form-group">
							<label for="email">Email</label>
							<input autocomplete="off" class="form-control" data-val="true" data-val-regex="Please enter valid Email" data-val-regex-pattern="^(([\w-+]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)|[\w]{0})$" id="email" name="email" placeholder="user@gmail.com" type="text" value="<?php echo $sel_email; ?>" autocomplete="off">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="Relative" style="position: relative;">
								...
								<button type="button" class="btn PasswordView InputButton">
									<span class="passwordline" data-show="0" onclick="showHidePassword(this, 'password');"><img src="<?php echo base_url('assets/frontend/images/view-password.svg'); ?>"></span>
								</button>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="Button">
							<div class="row">
								<div class="col-4">
									<a href="login-female.php"><button type="button" class="btn Secondary"><img src="<?php echo base_url();?>assets/frontend/images/Arrow-Left.svg" alt="->" /></button></a>
								</div>
								<div class="col-8">
						...
						<div class="DontHave AcceptNext">
							<p style="font-size: 15px;">By clicking “Next” I certify that I’m at least 18 years old and agree to the Secret Time <a href="javascript:void(0)"> PrivacyPolicy</a> and <a href="javascript:void(0)"> Terms</a></p>
						</div>
					</form>
				</div>
			</div>
		...
		<div class="container">
			<div class="col-md-5 d-block m-auto">
				...
				<div class="FormBox">
					...
					<form id="signupFemale1" method="POST" >
						<div class="form-group">
							<label for="email">Email</label>
						...
						<div class="form-group">
							<label for="username">Username</label>
							<input type="text" class="form-control  " id="username1" name="username" value="<?php echo $sel_username; ?>" placeholder="Visible by all members" autocomplete="off"/>
						</div>
						<div class="form-group">
...
$('#signupFemale, #signupFemale1').on('submit', function(e){       
    e.preventDefault();
    ...
    $.ajax({
        ...
        success: function (data) { 
            ...
            $('#showmsg').removeClass(' alert alert-info');
            if(data == "success"){
                window.location.href = "<?php echo base_url('female-register'); ?>";
                return true;
            }
