				...
				<div class="FormBox">
					...
					<form id="formLogin">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="username" name="username" placeholder="Visible by all members" autocomplete="off" />
						</div>
						<div class="form-group">
							<label for="password">Password</label>
							<div class="Relative" style="position: relative;">
								<input type="password" class="form-control Password" id="password"  name="password"  placeholder="minimum length: 6 characters" autocomplete="off" />
						...
						<div class="LoginClassForMobile">
							<div class="DontHave OnlyWeb">
								<p>Don't have an account? <a href="<?php echo base_url('female-signup'); ?>"> Register</a></p>
							</div>
							<div class="DontHave OnlyWeb">
						...
						<div class="DontHave PrivacyTextLogin">
							<p>By clicking login you agree to our <a href="<?php echo base_url(); ?>">terms</a> and <a href="#">privacy policy</a>.</a></p>
						</div>
					</form>
				</div>
			</div>
				...
				<div class="FormBox">
					...
					<form id="formLogin1">
						...
						<div class="form-group">
							<label for="password">Password</label>
							<div class="Relative" style="position: relative;">
								<input type="password" class="form-control Password" id="password1"  name="password" placeholder="minimum length: 6 characters" autocomplete="off" />
