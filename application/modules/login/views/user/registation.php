		...
		<div class="container">
			<div class="col-md-5 d-block m-auto">
				<div class="FormBox">
					...
					<form id="registerMale" method="POST" >
						...
						<div class="Button">
							<div class="row">
								<div class="col-4">									
								<a href="<?php echo  base_url('male-signup'); ?>"> <button type="button" class="btn Secondary" ><img src="<?php echo base_url();?>assets/frontend/images/Arrow-Left.svg" alt="->" /></button>	</a>
								</div>
								<div class="col-8">
		...
		<div class="container">
			<div class="col-md-5 d-block m-auto">
				<div class="FormBox">
					...
					<form id="registerMale1" method="POST">
						<div class="form-group">
							<div class="CustomRange">
								<div class="LebelEqual">
									<label><img src="<?php echo base_url();?>assets/frontend/images/refresh.svg" alt="refresh"> inches</label>
...
$('#registerMale, #registerMale1').on('submit', function(e){       
    e.preventDefault();
    ...
    // $('#myloader').show();
    $.ajax({
        url: '<?php echo base_url('validate-male-registration'); ?>',
        type: "POST",
        ...
        success: function (data) { 
            ...
            if(data == "signup"){
              ...
              $('#showmsg').show().delay(5000).fadeOut();
              $('#showmsg').addClass(' alert alert-danger');
              window.location.href = "<?php echo base_url('male-signup'); ?>";
              return true;
            }
