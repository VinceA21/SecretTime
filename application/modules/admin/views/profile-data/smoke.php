              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header">
                   <div class="row">
                      <div class="col-md-10"> 
                        <h3 class="card-title"><b> Smoke </b> </h3>                    
                      </div>
                      <div class="col-md-2"> 
                         <button data-toggle="modal" data-target="#addContentModel" class="btn btn-primary btn-sm pull-right">Add Smoke</button>
                      </div>
                  ...
                  <div class="card-body">
                    <table id="boxer-list" class="table table-striped">
                      ...
                      <tr>
                        ...
                        <td><button class="btn btn-primary btn-sm" data-code="<?php echo $data->smoke_code; ?>" data-name="<?php echo base64_encode($data->name); ?>" data-toggle="modal" data-target="#editContentModel" onclick="$('#editname').val(atob($(this).attr('data-name'))); $('#editcode').val($(this).attr('data-code'))"><i class="fa fa-pen" aria-hidden="true"></i> EDIT </button>
                        </td>

                        <td><button data-toggle="modal" data-target="#deleteContentModel" class="btn btn-danger btn-sm" data-code="<?php echo $data->smoke_code; ?>" onclick="$('#deletecode').val($(this).attr('data-code'))"> <i class="fa fa-trash" aria-hidden="true"></i> DELETE </button>
                        </td>
                      </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Add Smoke</h4>
      </div>
...
<div id="editContentModel" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Edit Smoke</h4>
      </div>
...
<div id="deleteContentModel" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Delete Smoke</h4>
      </div>
  ...
  $(function(){
    $('#addContentData').submit(function(e){
      ...
      e.preventDefault();
        ...
        $.ajax({
          url: "<?php echo base_url('admin/add-smoke'); ?>",
          type: "POST",
  ...
  $(function(){
    $('#editContentData').submit(function(e){
      ...
      e.preventDefault();
        ...
        $.ajax({
          url: "<?php echo base_url('admin/edit-smoke'); ?>",
          type: "POST",
          data: new FormData(this),
          processData: false,
          contentType: false,
  ...
  $(function(){
    $('#deleteContentData').submit(function(e){
      ...
      e.preventDefault();
        ...
        $.ajax({
          url: "<?php echo base_url('admin/delete-smoke'); ?>",
          type: "POST",
          data: new FormData(this),
          processData: false,
          contentType: false,
