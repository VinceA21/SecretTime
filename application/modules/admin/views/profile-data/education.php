              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header">
                   <div class="row">
                      <div class="col-md-10"> 
                        <h3 class="card-title"><b> Education </b> </h3>                    
                      </div>
                      <div class="col-md-2"> 
                         <button data-toggle="modal" data-target="#addContentModel" class="btn btn-primary btn-sm pull-right">Add Education</button>
                      </div>
                  ...
                  <div class="card-body">
                    <table id="boxer-list" class="table table-striped">
                      ...
                      <tr>
                        ...
                        <td><button class="btn btn-primary btn-sm" data-code="<?php echo $data->education_code; ?>" data-name="<?php echo base64_encode($data->name); ?>" data-toggle="modal" data-target="#editContentModel" onclick="$('#editname').val(atob($(this).attr('data-name'))); $('#editcode').val($(this).attr('data-code'))"><i class="fa fa-pen" aria-hidden="true"></i> EDIT </button>
                        </td>

                        <td><button data-toggle="modal" data-target="#deleteContentModel" class="btn btn-danger btn-sm" data-code="<?php echo $data->education_code; ?>" onclick="$('#deletecode').val($(this).attr('data-code'))"> <i class="fa fa-trash" aria-hidden="true"></i> DELETE </button>
                        </td>
                      </tr>
  ...
  $(function(){
    $('#addContentData').submit(function(e){
      ...
      e.preventDefault();
        ...
        $.ajax({
          url: "<?php echo base_url('admin/add-education'); ?>",
          type: "POST",
  ...
  $(function(){
    $('#editContentData').submit(function(e){
      ...
      e.preventDefault();
        ...
        $.ajax({
          url: "<?php echo base_url('admin/edit-education'); ?>",
          type: "POST",
          data: new FormData(this),
          processData: false,
          contentType: false,
  ...
  $(function(){
    $('#deleteContentData').submit(function(e){
      ...
      e.preventDefault();
        ...
        $.ajax({
          url: "<?php echo base_url('admin/delete-education'); ?>",
          type: "POST",
          data: new FormData(this),
          processData: false,
          contentType: false,
